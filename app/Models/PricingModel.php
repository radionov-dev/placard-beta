...
class PricingModel extends Model
{
	...
	protected $appends = ['per_label_buyer', 'per_label_buyer_display', 'quantity_label_buyer', 'quantity_label_buyer_display', 'can_seller_enter_per_label', 'bd_type', 'marketplace_percentage_fee'];
    ...
    public function getBdTypeAttribute() {
        return $this->meta->bd_type;
    }
