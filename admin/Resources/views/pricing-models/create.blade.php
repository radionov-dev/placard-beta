                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Marketplace percentage fee</label>
                                {{ Form::number('marketplace_percentage_fee', $pricing_model->meta->marketplace_percentage_fee, ['class' => 'form-control', 'min'=>0, 'max'=>100]) }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    {{ Form::radio('bd_type', '', (!$pricing_model->meta->bd_type), ['class' => 'form-check-input', 'id' => 'bd_type-none']) }}
                                    <label class="form-check-label" for="bd_type-none">None</label>
                                </div>
                                <div class="form-check">
                                    {{ Form::radio('bd_type', 'prepayment', ($pricing_model->meta->bd_type=='prepayment'), ['class' => 'form-check-input', 'id' => 'bd_type-prepayment']) }}
                                    <label class="form-check-label" for="bd_type-prepayment">Prepayment</label>
                                </div>
                                <div class="form-check">
                                    {{ Form::radio('bd_type', 'postpayment', ($pricing_model->meta->bd_type=='postpayment'), ['class' => 'form-check-input', 'id' => 'bd_type-postpayment']) }}
                                    <label class="form-check-label" for="bd_type-postpayment">Postpayment</label>
                                </div>
                                <div class="form-check">
                                    {{ Form::radio('bd_type', 'mediation', ($pricing_model->meta->bd_type=='mediation'), ['class' => 'form-check-input', 'id' => 'bd_type-mediation']) }}
                                    <label class="form-check-label" for="bd_type-mediation">Mediation</label>
                                </div>
                            </div>
											<hr />	
