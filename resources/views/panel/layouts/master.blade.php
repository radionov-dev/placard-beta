...
<body>
  ...
  <a class="navbar-brand" href="{{ url('/panel') }}" style="height: 48px; padding:16px 25px 10px 15px; color: #fff; font-size: 16px; width: 210px; background: #1a2226; color: #fff;     font-size: 12px; color: #4b646f; background: #1a2226;">PlaCard</a>
